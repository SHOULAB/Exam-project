            ...
            <form class="auth-form" id="registerForm" method="POST" action="">
                ...
                <div class="form-options form-options-stack">
                    <label class="checkbox-label">
                        ...
                        <span><span data-i18n="reg.privacy">Piekrītu</span> <a href="privacy_policy.php" class="link" data-i18n="reg.privacy.link" target="_blank" rel="noopener noreferrer">privātuma politikai</a></span>
                    </label>
                    <label class="checkbox-label">
                        <input type="checkbox" name="terms" class="checkbox-input" required>
                        <span><span data-i18n="reg.terms">Piekrītu</span> <a href="lietosanas_noteikumi.php" class="link" data-i18n="reg.terms.link" target="_blank" rel="noopener noreferrer">lietošanas noteikumiem</a></span>
                    </label>
                </div>
